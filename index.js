...
const tekrarEdenSayilarOb = {};
tekraredensayilar = [];
sayilar.forEach(sayi => {

  if(tekrarEdenSayilarOb[sayi1] === undefined){
    tekrarEdenSayilarOb[sayi1] = 1;
  }else {
    tekrarEdenSayilarOb[sayi1] += 1;
  }
});

for(let key in tekrarEdenSayilarOb){
  if(tekrarEdenSayilarOb[key] > 1) {
    tekraredensayilar.push('${key} sayisi ${tekrarEdenSayiOb[key]} kere tekrar edilmiştir.')
  }
}
